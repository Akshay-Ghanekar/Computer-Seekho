...
public interface StaffRepository extends JpaRepository<Staff, Integer> {
	...
	@Modifying
	@Query("update Staff s set s.staff_name = :name, s.photo_url= :photo, s.staff_mobile = :mobile, s.staff_email = :email, s.staff_username = :uname, s.staff_password = :pass, "
			+ "s.staff_role = :role, s.staff_isactive = :status where s.staff_id = :id" )
